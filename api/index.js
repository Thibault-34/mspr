...
const pointinteresttocategoryRouter = require('./routes/pointinteresttocategorys')
...
app.use('/categoryofpointinterests', categoryofpointinterestRouter)
app.use('/localisations', localisationRouter)
app.use('/pointinterests', pointinterestRouter)
app.use('/users', userRouter)
app.use('/pointinteresttocategorys', pointinteresttocategoryRouter)
app.use('*', (req, res) => {
